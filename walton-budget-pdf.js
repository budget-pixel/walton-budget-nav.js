...
(function(){
  ...
  function injectWaltonBudgetPdfStyles(){
...
`;
  ...
  function initWaltonBudgetPdf(){
    injectWaltonBudgetPdfStyles();
  ...
  if(document.readyState === 'loading'){
    document.addEventListener('DOMContentLoaded', initWaltonBudgetPdf);
  }else{
    initWaltonBudgetPdf();
  }
